...
public class IndicatorScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener {

    private IndicatorScroller mScrollbar;
    ...
    public IndicatorScrollRecyclerView(Context context) {
        this(context, null);
    }

    public IndicatorScrollRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IndicatorScrollRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mScrollbar = new IndicatorScroller(context, this, attrs);
    }
